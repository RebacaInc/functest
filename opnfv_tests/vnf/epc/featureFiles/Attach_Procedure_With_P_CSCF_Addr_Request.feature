...
Feature:  Attach Procedure With P-CSCF Address Request Indication in PCO
  ...
  Scenario: Attach Procedure indicating a request for P-CSCF address  in the protocol configuration options
    ...
    Then the ending steps are complete
        ...
        | Send PDN Connectivity Request message with P-CSCF Address Request | PRESENT |
        ...
        | Received Activate Default EPS Bearer Context Request message with PCO contain Protocol ID 0001 | PRESENT |
