...
Feature:  Attach Procedure With MS Support of Network Requested Bearer Control indicator in PCO
  ...
  Scenario: Attach Procedure indicating MS Support of Network Requested Bearer Control indicator
    ...
    Then the ending steps are complete
        ...
        | Send PDN Connectivity Request message with MS Support of Network Requested Bearer Control indicator | PRESENT |
        ...
        | Received Activate Default EPS Bearer Context Request message with PCO contain Protocol ID 0005 | PRESENT |
