...
Feature:  Attach Procedure With DNS Server Address Request Indication in PCO 
  ...
  Scenario: Attach Procedure indicating a request DNS Server Address in the protocol configuration options
    ...
    Then the ending steps are complete
        ...
        | Send PDN Connectivity Request message with DNS Server Address Request | PRESENT |
        ...
        | Received Activate Default EPS Bearer Context Request message with PCO contain Protocol ID 0003 | PRESENT |
